...
export const MONSTERS: readonly MonsterSpec[] = [
  ...
  },
  {
    ...
    hp: 4, attack: 3, ac: 0, dodge: 10, xp: 3,
    icon: 'rat.png',
  ...
  },
  {
    ...
    hp: 17, attack: 8, ac: 0, dodge: 12, xp: 10,
    icon: 'dog.png',
  ...
  },
  {
    ...
    hp: 24, attack: 12, ac: 0, dodge: 14, xp: 18,
    icon: 'wolf.png',
  ...
  },
  {
    ...
    hp: 28, attack: 14, ac: 0, dodge: 15, xp: 25,
  ...
  },
  {
    ...
    name: 'Large Snake',
    minLevel: 1, maxLevel: 6,
    hp: 12, attack: 7, ac: 0, dodge: 10, xp: 8,
    icon: 'snake.png',
  ...
  },
  {
    ...
    name: 'Viper',
    minLevel: 2, maxLevel: 8,
    hp: 14, attack: 5, ac: 0, dodge: 12, xp: 15,
    specials: ['poison'],
    icon: 'RSNAKE.png',
  ...
  },
  {
    ...
    name: 'Giant Scorpion',
    minLevel: 3, maxLevel: 10,
    hp: 20, attack: 10, ac: 5, dodge: 10, xp: 22,
    specials: ['poison'],
  ...
  },
  {
    ...
    hp: 15, attack: 9, ac: 3, dodge: 11, xp: 16,
    icon: 'spider.png',
  ...
  },
  {
    ...
    name: 'Huge Lizard',
    minLevel: 2, maxLevel: 8,
    hp: 22, attack: 6, ac: 4, dodge: 8, xp: 14,
    affinities: [...resist('fire'), ...vulnerable('cold')],
    icon: 'lizard.png',
  ...
  },
  {
    ...
    hp: 38, attack: 18, ac: 6, dodge: 10, xp: 40,
    icon: 'bear.png',
...

  {
    ...
    name: 'Kobold',
    minLevel: 1, maxLevel: 4,
    hp: 5, attack: 2, ac: 0, dodge: 8, xp: 3,
  ...
  },
  {
    ...
    name: 'Goblin',
    minLevel: 1, maxLevel: 5,
    hp: 17, attack: 8, ac: 0, dodge: 10, xp: 12,
    icon: 'goblin.png',
    ...
    loot: [
      ...
      { chance: 0.30, coins: { kind: 'silver', min:  1, max:  8 } },
  ...
  },
  {
    ...
    name: 'Goblin Fighter',
    minLevel: 2, maxLevel: 8,
    hp: 31, attack: 14, ac: 6, dodge: 12, xp: 30,
    icon: 'goblinf.png',
  ...
  },
  {
    ...
    name: 'Hobgoblin',
    minLevel: 3, maxLevel: 10,
    hp: 28, attack: 12, ac: 12, dodge: 14, xp: 35,
    icon: 'goblinf.png',
  ...
  },
  {
    ...
    hp: 20, attack: 8, ac: 6, dodge: 12, xp: 20,
  ...
  },
  {
    ...
    hp: 35, attack: 16, ac: 18, dodge: 12, xp: 45,
    icon: 'warrior.png',
  ...
  },
  {
    ...
    hp: 45, attack: 20, ac: 24, dodge: 8, xp: 60,
    icon: 'ogre.png',
  ...
  },
  {
    ...
    hp: 22, attack: 8, ac: 6, dodge: 18, xp: 30,
    extraAttacks: 2,
  ...
  },
  {
    ...
    hp: 59, attack: 24, ac: 75, dodge: 10, xp: 90,
    extraAttacks: 1,
    specials: ['regenerate'],
    affinities: [...vulnerable('fire')],
    icon: 'TROLL.png',
  ...
  },
  {
    ...
    name: 'Rat-Man',
    minLevel: 2, maxLevel: 9,
    hp: 20, attack: 10, ac: 0, dodge: 12, xp: 18,
    icon: 'ratman.png',
  ...
  },
  {
    ...
    hp: 48, attack: 20, ac: 70, dodge: 14, xp: 65,
    icon: 'wolfman.png',
  ...
  },
  {
    ...
    name: 'Bear-Man',
    minLevel: 6, maxLevel: 16,
    hp: 55, attack: 22, ac: 30, dodge: 10, xp: 75,
    extraAttacks: 1,
    icon: 'bearman.png',
...

  {
    ...
    name: 'Skeleton',
    minLevel: 1, maxLevel: 8,
    hp: 5, attack: 4, ac: 0, dodge: 6, xp: 5,
  ...
  },
  {
    ...
    hp: 8, attack: 5, ac: 0, dodge: 4, xp: 8,
    specials: ['random_move'],
    icon: 'zombie.png',
  ...
  },
  {
    ...
    name: 'Ghost',
    minLevel: 4, maxLevel: 14,
    hp: 18, attack: 0, ac: 0, dodge: 20, xp: 35,
  ...
  },
  {
    ...
    name: 'Shadow',
    minLevel: 3, maxLevel: 10,
    hp: 12, attack: 6, ac: 0, dodge: 14, xp: 20,
    specials: ['drain_str'],
  ...
  },
  {
    ...
    hp: 28, attack: 2, ac: 0, dodge: 12, xp: 55,
    specials: ['drain_str', 'drain_dex', 'drain_con'],
    icon: 'wight.png',
  ...
  },
  {
    ...
    hp: 150, attack: 50, ac: 60, dodge: 20, xp: 400,
    extraAttacks: 2,
    specials: ['breath_fire'],
    affinities: [...immune('fire'), ...vulnerable('cold')],
    icon: 'rdragon.png',
...

  {
    ...
    minLevel: 4, maxLevel: 14,
    hp: 30, attack: 4, ac: 0, dodge: 8, xp: 30,
    extraAttacks: 5,
    specials: [],
    affinities: [...vulnerable('fire')],
    icon: 'carrion.png',
  ...
  },
  {
    ...
    hp: 35, attack: 8, ac: 0, dodge: 4, xp: 50,
  ...
  },
  {
    ...
    name: 'Manticore',
    minLevel: 7, maxLevel: 18,
    hp: 65, attack: 20, ac: 80, dodge: 16, xp: 110,
    extraAttacks: 1,
  ...
  },
  {
    ...
    hp: 12, attack: 8, ac: 0, dodge: 0, xp: 15,
...

  {
    ...
    minLevel: 5, maxLevel: 14,
    hp: 45, attack: 18, ac: 40, dodge: 6, xp: 55,
...

  {
    ...
    hp: 120, attack: 32, ac: 12, dodge: 8, xp: 300,
    specials: ['ranged_stone'],
    isBoss: true,
    icon: 'HGIANTK.png',
  ...
  },
  {
    ...
    hp: 140, attack: 36, ac: 12, dodge: 9, xp: 400,
    specials: ['ranged_stone'],
    isBoss: true,
    icon: 'HGIANTK.png',
  ...
  },
  {
    ...
    hp: 200, attack: 60, ac: 70, dodge: 20, xp: 1000,
    specials: ['teleport_allies', 'breath_fire'],
    affinities: [...immune('fire'), ...resist('cold')],
    isBoss: true,
    icon: 'SURTUR.png',
