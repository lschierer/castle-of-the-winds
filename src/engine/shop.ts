...
export const SHOPS: Record<string, ShopDef> = {
  ...
  // ── Bjarnarhaven (fortress-town) shops ──────────────────────────────────
  "Bjorn's Smithy": {
    id: "Bjorn's Smithy",
    name: "Bjorn's Smithy",
    townTier: 'fortress-town',
    stockLevel: townStockLevel('fortress-town'),
    buys: ['weapon'],
    sells: ['weapon'],
    type: 'trade',
  },
  "Sverting's Armor": {
    id: "Sverting's Armor",
    name: "Sverting's Armor",
    townTier: 'fortress-town',
    stockLevel: townStockLevel('fortress-town'),
    buys: ['armor', 'helm', 'shield', 'bracers', 'gauntlets'],
    sells: ['armor', 'helm', 'shield', 'bracers', 'gauntlets'],
    type: 'trade',
  },
  "Rognvald's Outfitters": {
    id: "Rognvald's Outfitters",
    name: "Rognvald's Outfitters",
    townTier: 'fortress-town',
    stockLevel: townStockLevel('fortress-town'),
    buys: ['scroll', 'potion', 'spellbook', 'cloak', 'boots', 'container', 'belt'],
    sells: ['cloak', 'boots', 'container', 'belt', 'scroll', 'potion'],
    type: 'trade',
  },
  "Snorri the Sage": {
    id: "Snorri the Sage",
    name: "Snorri the Sage",
    townTier: 'fortress-town',
    stockLevel: townStockLevel('fortress-town'),
    buys: [],
    sells: [],
  ...
  "Olaf's Junk Store": {
    id: "Olaf's Junk Store",
    name: "Olaf's Junk Store",
    townTier: 'fortress-town',
    stockLevel: townStockLevel('fortress-town'),
    buys: [],
    sells: [],
  ...
  'First Bank': {
    id: 'First Bank',
    name: 'First Bank of Bjarnarhaven',
    townTier: 'fortress-town',
    stockLevel: townStockLevel('fortress-town'),
    buys: [],
    sells: [],
